...
\hypersetup{pdftitle={Experiment plan: turning the two findings into laws (version 8)}}
...
{\large Version 8, frozen on 18 September 2026. It amends version 7, frozen earlier that day, after stage 0 ran under it on all three pairs: their calibrations measured which slices each client can reach, and one session was stopped by a brake set below its own instrument's noise. No run this plan covers starts before it is public (Section~\ref{sec:freeze}).}\\[2pt]
{\color{soft}\small Grey text in brackets is a plain-word explanation. Green tags such as \chg{D8-1} mark what changed since version 7, and grey tags such as \chgold{D7-1}, \chgold{D6-1}, \chgold{D5-2} and \chgold{D3-5} what changed in earlier versions; the six tables below say what each change is and why. Prices are Azure's list prices as read again on 16 September 2026, and they change.}
