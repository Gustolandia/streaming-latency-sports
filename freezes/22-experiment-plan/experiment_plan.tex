...
\hypersetup{pdftitle={Experiment plan: turning the two findings into laws (version 26)}}
...
{\large Version 26, frozen on 25 September 2026. It records the corrections found on 25 September and changes no prediction. A5's session at 2 CPUs stopped twice on its got-it brake, on moves the added delay could not have made, and its last thirteen runs are run with the brake recording rather than stopping: a change made after those stops, and frozen before the runs it covers (D26-1). T2 holds a tool's count against what the tool was asked to send (D26-2); the Go tools' T2 moves the driver's own clock and puts it back (D26-3); and the tools block runs the four rounds it was always meant to (D26-4). No run this plan covers starts before it is public (Section~\ref{sec:freeze}).}\\[2pt]
{\color{soft}\small Grey text in brackets is a plain-word explanation. Green tags such as \chg{D26-1} mark what changed since version 25, and grey tags such as \chgold{D25-1}, \chgold{D24-1}, \chgold{D23-1}, \chgold{D22-1}, \chgold{D21-1}, \chgold{D20-1}, \chgold{D19-1}, \chgold{D17-1}, \chgold{D16-1}, \chgold{D15-1}, \chgold{D14-1}, \chgold{D13-1}, \chgold{D12-1}, \chgold{D11-1}, \chgold{D10-1}, \chgold{D9-1}, \chgold{D8-1}, \chgold{D7-1}, \chgold{D6-1}, \chgold{D5-2} and \chgold{D3-5} what changed in earlier versions; the twenty-two tables below say what each change is and why. Prices are Azure's list prices as read again on 16 September 2026, and they change.}
...
\boxit{Version 26 records the corrections of 25 September and changes no prediction. \chg{D26-1} A5's session at 2 CPUs finishes its last thirteen runs with the got-it brake recording rather than stopping, after two stops on moves the added delay could not have made; P7 at 2 CPUs is judged on the runs taken under the rule and again on all forty. \chg{D26-2} T2 holds a tool's count against what the tool was asked to send. \chg{D26-3} The Go tools' T2 moves the driver's own clock, puts it back after every run and checks that it is back. \chg{D26-4} The tools block runs its four rounds, each in a folder of its own. \chg{D26-5} Corrections that decide no verdict are recorded.}
