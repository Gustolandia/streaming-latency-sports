...
interval being measured, which is what puts the negative-span rate at $\spanNegAckPct\%$
rather than at a hundredth of that or at half. A mean over this distribution is dominated by a mode the operator never
...
admission condition and genuine negatives survive it (Supplements~S29 and~S16.5), which is
why the ordering above puts synchronization quality last.
