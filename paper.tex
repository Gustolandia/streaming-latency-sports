...
(Supplement~S41). That tick is the kernel's timer period, not the timestamp resolution $\tau$ of
...
\label{sec:tools}
The admission condition is not confined to the tool we measured: $\forkUnchanged$
...
clock-synchronization rival and nothing else. The configuration our audit rejects most often
