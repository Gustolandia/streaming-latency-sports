...
shift over $\recoveryShiftPairs$ pairs is $\recoveryShift$ points; what opens the median gap
is a concentration at zero, where $\recoveryPassExact\%$ of the passing conditions recover
the delivery exactly (Supplement~S16.9). The recovery therefore holds where the check
