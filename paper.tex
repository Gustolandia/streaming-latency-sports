...
be told apart. The worst condition is $\recoveryPassMax\%$ on either side; the Hodges--Lehmann
shift is $\recoveryShift$ points [95\% bootstrap:
$\recoveryShiftCI$]; what opens the median gap is a concentration at zero, and without the exact
recoveries no shift is detectable, $\recoveryNonzeroShift$ points [95\% bootstrap:
